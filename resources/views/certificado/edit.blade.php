...
@section("content")
    ...
    <form action="/certificado/{{$certificado->id}}" method="post" enctype="multipart/form-data" class="grabado">
        @csrf
        <div class="m-0 row justify-content-center">
                ...
                <div class="card m-3 row justify-content-center text-primary p-3">
                    ...
                    <div class="row card-body text-secondary">
                        ...
                        <div class="form-group col-12 mt-5">
                            ...
                            <textarea type="text" class="form-control" name="obsadicional" value="" rows="3">{{ old('obsadicional',$certificado->obsadicional)}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body text-secondary ">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-md-6">
                                ...
                                <input type="number" placeholder="VIGENCIA DE MEDICIÓN (AÑOS) :" class="form-control" name="vigenciamedicion" value="{{ old('vigenciamedicion',$certificado->vigenciamedicion)}}">
                                <input id="qr" name="qr" type="hidden" value="http://0.0.0.0/qrcode/{$id}">
            ...
            <div class="col-md-10">
                <div class="card m-3 row justify-content-center text-primary p-3" >
                    <div class="card-header bg-primary text-white">
                        <h4 style="text-align: center">IMÁGENES</h4>
                    </div>
                    <div class="form-group col-xs-12 col-md-12">
                        <BR>
                        <label for="">FOTO PARA EL CERTIFICADO</label> <br>

                        <img id="output" class="img-fluid" src="../../imagenes/certificados/{{$certificado->id}}-fotocertif.jpg" width="200px;">

                        <br><label for="">REEMPLAZAR</label><br>
                        <span class="text-secondary">La relación de aspecto debe ser de 5:3 ( Ejemplo: 500px:300px)</span><br>
                        <input type="file" class="form-control-file" name="fotocertif" value="{{ old('fotocertif',$certificado->fotocertif)}}"  onchange="loadFile(event)" >
                        ...
                        @foreach($certificado->images as $image)
                            <div  class="col-sm-2" >
                                <a href="../../imagenes/{{ $image->url }}" data-toggle="lightbox"  data-title="Id: {{ $image->id }}"  data-gallery="gallery">
                                    <img style="width: 150px; height:150px;" src="../../imagenes/{{ $image->url }}" class="img-fluid mb-2"/>
                                </a>
                                <br>
                                <a href="{{ $image->url }}">
                            ...
                            <div id="app">
                                <notification inline-template>
                                    <div class="notification">
                                        Well done <a href='https://jsfiddle.net'  wire:click.prevent = "eliminarimagen" >click here</a>
                                    </div>
                                </notification>
                            </div>
