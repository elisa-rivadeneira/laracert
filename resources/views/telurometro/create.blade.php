...
@section("content")
    ...
    <form action="/telurometros" method="post" enctype="multipart/form-data" class="grabado">
        @csrf
        <div class="m-0 row justify-content-center">
            <div class="col-md-10">
                <h1 class="text-center">DATOS DEL TELURÓMETRO</h1>
                <div class="card">
                       <div class="row card-body">
                            <div class="form-group col-xs-12 col-md-12">
                            <label for="">TIPO</label>
                            <input id="tipo" tipo="aa" type="text" class="form-control" name="tipo" value="{{ old('tipo') }}">
                        ...
                        <div class="form-group col-xs-12 col-md-6">
                            ...
                            <input type="date" class="form-control" name="fechacalib" value="{{ old('fechacalib') }}">
                        ...
                        <div class="form-group col-xs-12 col-md-6">
                            ...
                            <input type="number" class="form-control" name="vigenciacalib" value="{{ old('vigenciacalib') }}">
