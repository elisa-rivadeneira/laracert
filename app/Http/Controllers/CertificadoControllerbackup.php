...
// dd($certificados);
  //     $certificados =  Certificado::orderBy('id', 'desc')->get();
    ...
    public function save(Request $request)
    {
        ...
        $pdf =PDF::loadView('certificado.pdf', compact("firma", "certificado", "telurometro", "telurometros", "firmas","qrcodigo","ubigeo", "sqlfirmas"))->save('protocolos/protocolo-000'.$certificado->id.'.pdf');
